...
import com.zzhoujay.markdown.image.GlideImageGetter;
...
public class MainActivity extends Activity {
    ...
    private void setText(int resId) {
        ...
        mTextView.post(new Runnable() {
            ...
            public void run() {
                ...
                Spanned spanned = MarkDown.fromMarkdown(stream, new GlideImageGetter(mTextView), mTextView.getContext());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        sub.add(0, R.raw.hello2,    0, "hello");
